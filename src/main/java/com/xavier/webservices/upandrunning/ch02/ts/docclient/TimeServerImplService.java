 ...
 * 
 */
@WebServiceClient(name = "TimeServerImplService", targetNamespace = "http://ts.ch01.upandrunning.webservices.xavier.com/", wsdlLocation = "http://127.0.0.1:9876/ts?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TIMESERVERIMPLSERVICE_QNAME = new QName("http://ts.ch01.upandrunning.webservices.xavier.com/", "TimeServerImplService");
    ...
    public TimeServer getTimeServerImplPort() {
        return super.getPort(new QName("http://ts.ch01.upandrunning.webservices.xavier.com/", "TimeServerImplPort"), TimeServer.class);
    }
    ...
    public TimeServer getTimeServerImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ts.ch01.upandrunning.webservices.xavier.com/", "TimeServerImplPort"), TimeServer.class, features);
    }
