 ...
 * 
 */
@WebServiceClient(name = "TempConvertService", targetNamespace = "http://tempConvertURI.org/", wsdlLocation = "http://localhost:8888/tempconverter?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TEMPCONVERTSERVICE_QNAME = new QName("http://tempConvertURI.org/", "TempConvertService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8888/tempconverter?wsdl");
    ...
    public TempConvert getTempConvertPort() {
        return super.getPort(new QName("http://tempConvertURI.org/", "TempConvertPort"), TempConvert.class);
    }
    ...
    public TempConvert getTempConvertPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempConvertURI.org/", "TempConvertPort"), TempConvert.class, features);
    }
