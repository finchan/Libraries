 ...
 * generated in the com.xavier.webservices.upandrunning.ch03.binary.mtomattachmentclient package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetImagesResponse_QNAME = new QName("http://mtomattachmentservice.binary.ch03.upandrunning.webservices.xavier.com/", "getImagesResponse");
    private final static QName _GetImages_QNAME = new QName("http://mtomattachmentservice.binary.ch03.upandrunning.webservices.xavier.com/", "getImages");
    private final static QName _GetImage_QNAME = new QName("http://mtomattachmentservice.binary.ch03.upandrunning.webservices.xavier.com/", "getImage");
    private final static QName _GetImageResponse_QNAME = new QName("http://mtomattachmentservice.binary.ch03.upandrunning.webservices.xavier.com/", "getImageResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.xavier.webservices.upandrunning.ch03.binary.mtomattachmentclient
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mtomattachmentservice.binary.ch03.upandrunning.webservices.xavier.com/", name = "getImagesResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mtomattachmentservice.binary.ch03.upandrunning.webservices.xavier.com/", name = "getImages")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mtomattachmentservice.binary.ch03.upandrunning.webservices.xavier.com/", name = "getImage")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://mtomattachmentservice.binary.ch03.upandrunning.webservices.xavier.com/", name = "getImageResponse")
