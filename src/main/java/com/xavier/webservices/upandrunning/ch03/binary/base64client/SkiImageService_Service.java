 ...
 * 
 */
@WebServiceClient(name = "SkiImageService", targetNamespace = "http://base64service.binary.ch03.upandrunning.webservices.xavier.com/", wsdlLocation = "http://localhost:8888/ski?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8888/ski?wsdl");
