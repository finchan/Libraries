 ...
 * 
 */
@WebServiceClient(name = "SkiImageService", targetNamespace = "http://mtomattachmentservice.binary.ch03.upandrunning.webservices.xavier.com/", wsdlLocation = "file:/F:/Practice/Libraries/src/main/java/com/xavier/webservices/upandrunning/ch03/binary/mtomattachmentclient/ski.wsdl")
    ...
    extends Service
{
    ...
    private final static QName SKIIMAGESERVICE_QNAME = new QName("http://mtomattachmentservice.binary.ch03.upandrunning.webservices.xavier.com/", "SkiImageService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/F:/Practice/Libraries/src/main/java/com/xavier/webservices/upandrunning/ch03/binary/mtomattachmentclient/ski.wsdl");
    ...
    public SkiImageService getSkiImageServicePort() {
        return super.getPort(new QName("http://mtomattachmentservice.binary.ch03.upandrunning.webservices.xavier.com/", "SkiImageServicePort"), SkiImageService.class);
    }
    ...
    public SkiImageService getSkiImageServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://mtomattachmentservice.binary.ch03.upandrunning.webservices.xavier.com/", "SkiImageServicePort"), SkiImageService.class, features);
    }
