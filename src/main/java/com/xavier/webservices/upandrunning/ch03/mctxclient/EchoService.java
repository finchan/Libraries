 ...
 * 
 */
@WebServiceClient(name = "EchoService", targetNamespace = "http://mctx.ch03.upandrunning.webservices.xavier.com/", wsdlLocation = "http://localhost:8888/echo?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ECHOSERVICE_QNAME = new QName("http://mctx.ch03.upandrunning.webservices.xavier.com/", "EchoService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8888/echo?wsdl");
    ...
    public Echo getEchoPort() {
        return super.getPort(new QName("http://mctx.ch03.upandrunning.webservices.xavier.com/", "EchoPort"), Echo.class);
    }
    ...
    public Echo getEchoPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://mctx.ch03.upandrunning.webservices.xavier.com/", "EchoPort"), Echo.class, features);
    }
