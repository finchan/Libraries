 ...
 * 
 */
@WebServiceClient(name = "TeamsService", targetNamespace = "http://team.ch01.upandrunning.webservices.xavier.com/", wsdlLocation = "http://localhost:8888/teams?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TEAMSSERVICE_QNAME = new QName("http://team.ch01.upandrunning.webservices.xavier.com/", "TeamsService");
    ...
    public Teams getTeamsPort() {
        return super.getPort(new QName("http://team.ch01.upandrunning.webservices.xavier.com/", "TeamsPort"), Teams.class);
    }
    ...
    public Teams getTeamsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://team.ch01.upandrunning.webservices.xavier.com/", "TeamsPort"), Teams.class, features);
    }
